...
fun LoginScreen(navController: NavController){
   Box {
       Image(
           ...
           colorFilter = ColorFilter.tint(Color.Green, BlendMode.ColorBurn)
       )
       ...
       Column(
           ...
           Text(text = "Login Page...", color = Color.Black, fontWeight = FontWeight.Bold, fontSize = 22.sp,
...
@Preview(showBackground = true, name = "Loginone...")
@Composable
fun PreviewS() {
    Column(
        modifier = Modifier.fillMaxSize(),
