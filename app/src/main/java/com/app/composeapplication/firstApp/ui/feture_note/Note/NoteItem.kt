...
import com.app.composeapplication.fifthApp.ui.screens.note.MyNoteitems
    ...
    Box(modifier = modifier) {
       Canvas(modifier = Modifier.matchParentSize() ){
           ...
           clipPath(clipPath){
               ...
               drawRoundRect(color = Color(ColorUtils.blendARGB(note.color, 0x000, 0.2f)),
...
fun priviewN() {
    ComposeApplicationTheme {
        NoteItem( note= Note(title = "rajat", content = "gfhfhfh", timeStyamp = 0L, color = 1233333),modifier =Modifier,10.dp,8.dp) {}
    }
}